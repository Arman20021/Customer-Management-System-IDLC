        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdatedDate = table.Column<DateTime>(type: "datetime2(0)", precision: 0, nullable: false, defaultValueSql: "(sysutcdatetime())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "CustomerMobiles",
                columns: table => new
                {
                    CustomerMobileId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    MobileNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    MobileType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerMobiles", x => x.CustomerMobileId);
                    table.ForeignKey(
                        name: "FK_CustomerMobiles_Customers",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerMobiles_CustomerId",
                table: "CustomerMobiles",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "UX_CustomerMobiles_MobileNumber",
                table: "CustomerMobiles",
                column: "MobileNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Customers_EmailAddress",
                table: "Customers",
                column: "EmailAddress",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UX_Customers_NationalIdNumber",
                table: "Customers",
